...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            alt="Three points in a two-dimensional space, illustrating the concept of distance between points a, b, and c."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Comparison of how Euclidean, Manhattan, and Angular distances measure relationships between points in two-dimensional space."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Endmember spectra for Calcite, Kaolinite, Muscovite, and Quartz, showing the spectral signatures used in the unmixing process."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Histogram showing the accuracy (RMSE) of 1000 spectral unmixing using three different distance metrics: Euclidean, Manhattan, and Angular."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Histogram showing the accuracy (RMSE) of 1000 spectral unmixing using three different distance metrics with random 'spikes' in the mixture."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Histogram showing the accuracy (RMSE) of 1000 spectral unmixing using three different distance metrics with added brightness difference in the mixture."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Two kaolinite spectra with different brightness values, demonstrating the effect of angular distance in spectral unmixing."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Endmember spectra for 10 minerals selected from the USGS spectral library, used in a more complex spectral unmixing scenario."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded" 
            alt="Visualization of different types of noise (Gaussian, uniform, gamma, Poisson) and a random constant added as a brightness modifier to the mixture."
        %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid 
            ...
            class="img-fluid rounded"
            alt="Histogram showing the accuracy (RMSE) of 1000 sepctral unmixing using three different distance metrics." 
        %}
    </div>
</div>
<div class="caption">
