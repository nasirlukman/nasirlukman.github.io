...
<div class="row mt-3">
    {% include figure.liquid path="assets\img\post_1_image_1_three_point_distance.png" class="img-fluid rounded z-depth-1" %}
</div>
<div class="caption">
    Image 1. Three points in two dimensional space 
</div>
{% include figure.liquid path="assets\img\post_1_image_1_three_point_distance.png" class="img-fluid rounded z-depth-1" %}
<img src="assets\img\post_1_image_1_three_point_distance.png">
