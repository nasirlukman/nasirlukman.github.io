---
layout: post
title: Exploratior Data Analysis (EDA) for Hyperspectral Imagery
date: 2024-12-09 23:36:10
description: My typical approach on EDA for a new hyperspectral projects. Includes method such as PCA/MNF, K-Means, N-FINDR, FCLS, and Minimum Wavelength Mapping. 
tags: 
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_composite.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 1. False color composite image 
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_basic_interpretation.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_mean_histogram.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_albedo_class.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_PCA.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_WCSS.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 6. WCSS result for $$ K $$ values ranging from 1 to 11.

Using $$ K=3 $$ , we perform clustering, with the results shown below:

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_cluster_map.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_cluster_spectra.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 7. Average spectra of each cluster
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_nfindr_plot.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 8. Data shape in reduced 2 PCA dimension showing clear linear relationship between three endmembers. Red star is the vertex of the triangle which corespond to the purest pixel on the image.

This is one of the most texbook like 2D PCA representations of a real hyperspectral image I have encountered.  The 2D simplex (triangle) is almost perfectly formed, indicating that our entire dataset can be described as a linear combination of three endmember spectra. These endmembers therefore must be the pixel that correspond to the vertices of the triangle. After transforming the extracted endmembers back into the original data space, we observe their pure spectral signatures:

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_endmember_spectra.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 9. Spectra of the purest pixels (endmembers).
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_unmixing_result.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 10. Unconstrained abundance of the three endmembers.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_unmixing_result_ternary_with_legend.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 11. Ternary map of the unconstrained abundance of the three endmembers
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/post_4_minwav.png" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
    Image 12. Minimum wavelength position histogram for the whole spectral range
